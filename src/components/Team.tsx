      ...
      <div className="container-page">
        ...
        <div className="mt-10 border-t border-rule-strong">
          {team.map((member, i) => (
            ...
            >
              <span className="mono col-span-2 text-[0.85rem] text-bone-faint sm:col-span-1">
                {String(i + 1).padStart(2, "0")}
              </span>
              <h3 className="display col-span-10 text-[1.6rem] leading-none sm:col-span-5">
                {member.name}
              </h3>
              <p className="col-span-12 text-[0.98rem] text-bone-dim sm:col-span-6">
                {member.title}
              </p>
            </div>
          ))}
        ...
        <p className="mono mt-6 text-[0.82rem] text-bone-faint">
