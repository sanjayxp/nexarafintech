...
export default function ArticleForm({
  ...
  return (
    <form action={action} className="mt-8 flex max-w-2xl flex-col gap-6">
      ...
      <div>
        <label htmlFor="tag" className="text-sm font-medium text-brand-navy">
          Tag
        </label>
        <input
          id="tag"
      ...
      <div>
        <label htmlFor="cover" className="text-sm font-medium text-brand-navy">
          Cover photo
        </label>
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1.5 w-full rounded-md border border-brand-border px-3 py-2 font-mono text-sm text-brand-navy focus:border-brand-teal focus:outline-none"
        />
        <p className="mt-1 text-xs text-brand-slate-light">
          Leave a blank line between paragraphs. Start a line with{" "}
          <code className="rounded bg-brand-surface px-1 py-0.5">## </code>{" "}
          to add a subheading.
        </p>
      </div>
